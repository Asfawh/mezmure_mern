...
resource "aws_cloudfront_origin_access_control" "site" {
  name                              = "mezmure-site-oac"
  description                       = "Private access to the Mezmure site bucket"
...
data "archive_file" "api" {
  ...
  output_path = "${path.module}/mezmure-api.zip"
  excludes    = [".env", ".env.example", "readme.md"]
}

resource "aws_iam_role" "lambda" {
  name = "mezmure-api-lambda-role"
