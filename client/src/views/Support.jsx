...
const supportAreas = [
  {
    number: '01',
    title: 'Cloud hosting',
    description: 'AWS hosting keeps the library fast and available worldwide.',
  },
  {
    number: '02',
    ...
    <div className="support-page">
      <section className="support-hero" aria-labelledby="support-title">
        <div className="support-hero-copy">
          ...
          <p className="support-amharic" lang="am">
            ድጋፍዎ የመዝሙር ማኅደሩን ተደራሽ እና ቀጣይ ያደርገዋል።
          </p>
        </div>
      </section>
      ...
      <section className="support-content" aria-label="Donation information">
        ...
        <aside className="support-checkout-card">
          ...
          <p>
            Choose any amount on our payment provider&apos;s secure checkout.
          </p>
      ...
      <section className="support-thanks">
        ...
        <div>
          ...
          <p>
            Your generosity helps carry this sacred tradition forward.
          </p>
        </div>
      </section>
    </div>
